    ...
    <>
      <nav className="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 fixed top-0 w-full z-50">
        <div className=" flex flex-wrap justify-between items-center mx-auto  p-3">
          <Link
            to={`/`}
            className=" md:order-2 order-2 flex items-center space-x-3 rtl:space-x-reverse"
          >
          ...
          <div
            className={`order-1 md:order-1 items-center justify-between font-medium w-full md:flex md:w-auto ${isOpenModal ? '' : 'hidden'}`}
          >
        ...
        <div
          className={`mt-1 border-gray-200 shadow-sm bg-gray-50 md:bg-transparent border-y dark:bg-gray-800 dark:border-gray-600 ${isOpen ? '' : 'hidden'}`}
        >
          <div
