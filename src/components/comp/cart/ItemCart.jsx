    ...
    <>
      <div className="md:flex items-center mt-0 py-8 border-t border-gray-200">
        ...
        <div className="md:pl-3 md:w-3/4">
          <p className="text-xs leading-3 text-gray-800 md:pt-0 pt-4">{data?.series}</p>
          <div className="flex">
            <div className="flex items-center justify-between w-full">
              <p className="text-base font-black leading-none text-gray-800">{data?.name}</p>
            </div>
          ...
          <p className="text-xs leading-3 text-gray-600 pt-2">Size: {data?.size}</p>
          <p className="text-xs leading-3 text-gray-600 py-4">Color: Black</p>
          <p className="w-96 text-xs leading-3 text-gray-600">Composition: {data?.composition}</p>
          <div className="flex items-center justify-between pt-5 pr-6">
            <div className="flex items-center">
              <button onClick={handleDelete} className="text-xs leading-3 underline text-red-500 pl-5 cursor-pointer">Remove</button>
            </div>
