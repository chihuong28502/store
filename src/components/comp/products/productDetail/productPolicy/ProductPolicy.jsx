      ...
      <div className=" mb-2">
        ...
        >
          <p className="font-normal text-[0.85rem]">
            ...
            + Sử dụng chất liệu vải 100% cotton định lượng 230 gsm dày dặn, thấm
            hút mồ hôi tốt.
            <br />
            + Thiết kế in lưới graphic những chai rượu quen thuộc và phổ biến
            tại kệ tủ của nhiều quán bar.
            <br />
            + Được thể hiện cách điệu qua dạng hình vẽ tay, và sắp xếp xen kẽ
            tạo thành pattern cho chiếc áo.
            <br />
        ...
        >
          <p className="leading-normal font-sans text-black mb-1  text-[0.75rem]">
            <span className="font-sans">
              <span>✦</span> Đối với sản phẩm bị lỗi các chi tiết trên áo khi
              chưa can thiệp sử dụng hay giặt tẩy, Candles sẽ tiến hành kiểm tra
              và đổi mới sản phẩm.
            </span>
          </p>
          <p className=" leading-normal font-sans text-black mb-1 text-[0.75rem]">
            <span className="font-sans">
              <span>✦</span> Đối với sản phẩm bị lỗi do quá trình vận chuyển,
              Candles sẽ khắc phục tuỳ tình trạng hoặc đổi mới.
            </span>
          </p>
        </div>
      </div>
      <div>
        ...
        >
          <p className="leading-normal font-sans text-black mb-2 text-[0.75rem]">
            <span className="font-sans">
              <span>✦</span> Đổi hàng trong vòng 3 ngày với đơn nội thành; 7
              ngày với đơn COD (sản phẩm chưa qua sử dụng và còn nguyên tag;
              mác).
            </span>
          </p>
          <p className="leading-normal font-sans text-black mb-2 text-[0.75rem]">
            <span className="font-sans">
              <span>✦</span> Sản phẩm muốn đổi có giá trị bằng hoặc cao hơn sản
              phẩm cũ (quý khách vui lòng thanh toán phí ship hai chiều).
            </span>
          </p>
          <p className="leading-normal font-sans text-black mb-2 text-[0.75rem]">
            <span className="font-sans">
