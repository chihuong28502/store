      ...
      <div className="md:mt-5 p-5 flex flex-col-reverse lg:flex lg:flex-row lg:justify-between">
        <div className="flex-1 flex gap-2 flex-col lg:w-[60%] lg:px-[15vw] lg:h-[100%] lg:flex-none lg:justify-center">
          ...
          <form className="flex flex-col gap-4">
            ...
            <Link to={`/login`} className='md:w-[50%] md:m-0 m-2 w-[100%] flex justify-center h-11 rounded-lg bg-blue-600 text-white cursor-pointer'>
                <button>Sign in</button>
              </Link>
              <button className="md:w-[50%] md:m-0 m-2 w-[100%] h-11 rounded-lg bg-blue-600 text-white cursor-pointer">Sign up</button>
            </div>
          </form>
