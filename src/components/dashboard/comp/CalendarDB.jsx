...
const CalendarDB = () => {
  ...
  const [events, setEvents] = useState([
    { event_title: 'Example Event', event_date: '2024-06-28', event_theme: 'blue' },
    { event_title: 'Example Event', event_date: '2024-06-29', event_theme: 'blue' }
  ]);
              ...
              <div className="fixed z-40 top-0 right-0 left-0 bottom-0 h-full w-full bg-black bg-opacity-75 flex justify-center items-center">
                <div className="max-w-xl mx-auto bg-white rounded-lg overflow-hidden">
                  <div className="flex justify-between items-center p-4 border-b">
                    <h2 className="font-bold text-2xl text-gray-800">Add Event Details</h2>
                    <button
